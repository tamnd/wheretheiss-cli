...
```
wheretheiss <command> [arguments] [flags]
```

Run `wheretheiss <command> --help` for the full flag list on any command. This
...
per operation you declare in `wheretheiss/domain.go`.
