...
Most of these come down to network reality or how wheretheiss serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

wheretheiss rate-limits like any public site. wheretheiss already paces
...
Where a surface is gated, wheretheiss reads a cookie or token you supply
...
`wheretheiss`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what wheretheiss actually did
